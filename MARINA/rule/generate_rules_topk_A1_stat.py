...
rule_file = open('/home/mnc/p4-dev/topk/rule/rule_file.txt', 'r+')
data = rule_file.read()

port_mapping = {}
port_mapping['edge1'] = 2
port_mapping['edge2'] = 2
port_mapping['edge3'] = 0
port_mapping['edge4'] = 0
...
for i in range(8):
    ...
    rule_file = open('/home/mnc/p4-dev/topk/rule/rule_file.txt', 'r+')
    dest_file = open('/home/mnc/p4-dev/topk/rule/edge/edge%s' %str(i), 'w+')
...
for i in range(8):
    ...
    rule_file = open('/home/mnc/p4-dev/topk/rule/rule_file.txt', 'r+')
    dest_file = open('/home/mnc/p4-dev/topk/rule/aggr/aggr%s' %str(i), 'w+')
...
for i in range(4):
    ...
    rule_file = open('/home/mnc/p4-dev/topk/rule/rule_file.txt', 'r+')
    dest_file = open('/home/mnc/p4-dev/topk/rule/core/core%s' %str(i), 'w+')
