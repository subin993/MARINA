...
def main():
    ...
    if a.dist == 'z':
        with open('/home/mnc/p4-dev/topk/packets/dataset/z_dist_%s_%s' %(p, str(a.entry)), 'r') as f:
        ...
        with open('/home/mnc/p4-dev/topk/packets/dataset/u_dist_%s' %(str(a.entry)), 'r') as f:
            for i in range(a.num):  #TODO
                line = f.readline()
                n = line.split()
