    ...
    if a.dist == 'z':
        ...
        if a.fat_tree == 1: #TODO
            ...
            if a.sort == 1 or a.sort== 3 :
                if a.sort == 1:
                    f = open('/home/mnc/p4-dev/topk/packets/dataset/z_dist_%s_%s_%s_sorted1' %(p, str(a.entry), str(a.num*10)), 'r')
                if a.sort == 3:
                    f = open('/home/mnc/p4-dev/topk/packets/dataset/z_dist_%s_%s_%s_sorted3' %(p, str(a.entry), str(a.num*10)), 'r')
            else: # sort == 2
